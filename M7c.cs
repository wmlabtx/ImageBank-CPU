...
namespace ImageBank
{
    public static class M7c
    {
        ...
        public static int[] YCoeff, CbCoeff, CrCoeff;

        private static int numCCoeff = 3, numYCoeff = 6;
        ...
        private static Bitmap colorLayoutImage;

        public static void Apply(Bitmap src)
        {
        ...
        public static Bitmap getColorLayoutImage()
        {
        ...
        public static double CalculateDistance(int[] YCoeff1, int[] CbCoeff1, int[] CrCoeff1, int[] YCoeff2, int[] CbCoeff2, int[] CrCoeff2)
        {
