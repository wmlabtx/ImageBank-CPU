...
using ImageBank.Extensions;
using ImageBank.PathProviders;
using ImageBank.Quantizers;

namespace ImageBank.Helpers
{
    public class ImageBuffer : IDisposable
    {
        ...
        private class LineTask
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ImageBank.Helpers.ImageBuffer.LineTask"/> class.
            /// </summary>
